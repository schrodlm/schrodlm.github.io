...
**Případ velkého univerza (Lemma K):** Když máme luxus obrovského $p$ ($p≥2km$), zhorší se nezávislost jen faktorem **$2$**. (Typicky u [polynomů](/notes/rodina-polynomialnich-hashovacich-funkci.html), nebo optimalizované lineární kongruence).
...
Nechť $\mathcal{H}$ je [(2,c)-nezávislá](/notes/k-nezavislost.html) [rodina funkcí](/notes/rodina-hashovacich-funkci.html) z univerza $U$ do $[r]$ a nechť $m < r$. Potom rodina funkcí 
