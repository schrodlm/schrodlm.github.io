...
Musí tedy dát definici toho, co je to vůbec algoritmus. Tento výraz definuje pomocí [výpočetních modelů](/notes/vypocetni-model.html).
...
### 1. [Rozhodovací problémy](/notes/rozhodovaci-problemy.html) (jazyky)
Reprezentují se typicky pomocí [jazyků](/notes/formalni-jazyk.html)
**Výstup:** ANO/NE
...
Vyčíslitelnost je definována pomocí **[rozhodnutelnosti](/notes/rozhodnutelnost.html)**.
...
**Formalizace:** [parciální funkce](/notes/parcialni-funkce.html) $f: Σ^* \to Σ^*$

**Vyčíslitelnost:** Funkce f je **vyčíslitelná** ⟺ existuje [univerzální turingův stroj](/notes/univerzalni-turinguv-stroj.html), který ji počítá.
...
**Vztah:**
- Pro [totální funkce](/notes/totalni-funkce.html): $f$ je vyčíslitelná $⟺$ $L_f$ je rozhodnutelný
	- Pokud existuje algoritmus, který ji počítá, pak existuje i algoritmus, který rozhoduje $L_f$
- Pro [parciální funkce](/notes/parcialni-funkce.html): $f$ je vyčíslitelná $⟹$ $L_f$ je rekurzivně spočetný
...
4. **Definovaná hierarchie** - [Chomského hierarchie](/notes/chomskeho-hierarchie.html)
