...
K implementaci komunikace v distribuovaném systému používáme abstrakce v podobě [komunikačních modelů](/notes/komunikacni-model/).

---
Je důležité rozdělit systém ve kterém komunikace probíhá a náturu jakou v tomto systému má komunikace předpoklady. [modely časování (timing models)](/notes/modely-casovani-timing-models/)

## Typy komunikací
Komunikace v distribuovaných systémech se dělí podle synchronnosti, vazby v čase, adresování, záruk doručení a pořadí – a každá volba přímo ovlivňuje konzistenci, stavovost a [spolehlivost distribuovaného systému](/notes/spolehlivost-distribuovaneho-systemu/).
...
- **Příklad:** [RPC](/notes/rpc/), HTTP Request/Response.
...
[skupinová komunikace (broadcast)](/notes/skupinova-komunikace-broadcast/)
