...
Jak zajistit, aby do kritické sekce (CS) v [distribuovaných systémech](/notes/distributed-system.html) vstoupil v daný okamžik jen jeden proces, když nemáme sdílenou paměť (a nemůžeme tedy použít klasická [synchronizační primitiva](/notes/synchronizacni-primitiva.html))? Jedná se o [mechanismus koordinace](/notes/mechanismy-koordinace-v-distribuovanych-systemech.html). Existují tři hlavní přístupy.
...
#### 2. Permission-Based (Např. Ricart-Agrawala, [Lamportův algoritmus](/notes/lamportuv-algoritmus.html))
...
#### 3. Quorum-Based (např. [Maekawa's algorithm](/notes/maekawas-algorithm.html))
