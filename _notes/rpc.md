...
Důležité je také mít na pamětí důležitost [idempotence v RPC](/notes/idempotence-v-rpc/)
...
2. **Client Stub:**
    - Převezme volání.
    - Provede [marshalling](/notes/marshalling/): Vezme parametry (čísla 5 a 10) a zabalí je do standardizovaného formátu zprávy (např. JSON)    
...
6. **Server Stub (Skeleton):**
    - Provede [Unmarshalling](/notes/marshalling/): Rozbalí zprávu a vytáhne z ní parametry (5, 10).
...
10. **Server Stub:** Provede [marshalling](/notes/marshalling/) výsledku (zabalí číslo 15 do zprávy).
11. **Transport:** Zpráva putuje po síti zpět ke klientovi.
12. **Client Stub:**
    - Přijme zprávu.
    - Provede **[unmarshalling](/notes/marshalling/)** (vytáhne číslo 15).
...
---
## Garance
### [Spolehlivost (delivery semantics)](/notes/spolehlivost-delivery-semantics/)
