...
- **Stateful přístup (Sessions):**
    ...
    - **Problém pro architekturu:** Pokud máš 10 serverů a [load balancer](/notes/load-balancer.html).
    - **Sticky Sessions (Session Affinity)**. [load balancer](/notes/load-balancer.html) musí pamatovat, že "Jana" musí posílat vždy na "Server 1", protože "Server 2" jeho session v paměti nemá. To komplikuje škálování.
