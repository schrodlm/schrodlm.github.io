---
layout: course
title: "NTIN066 - Datové struktury 1"
course_code: NTIN066
university: MFF
semester: 1
year: 2025
...
# Ratings (1-10 scale for consistency)
difficulty: 4
usefulness: 5
teaching_quality: 4
worth_it: true
...
# Links
course_page: https://iuuk.mff.cuni.cz/~vesely/vyuka/Podzim25/ds1.html
...
Úkoly byly víceméně jednoduché až na výjímky v podobě experimentů. Ty jsou celkem tři a každý z nich mi zabavil alespoň den, ale skvěle si na nich vysvětlíte a ujasníte věci co jste zjistili na přednáškách.

### Zkouška
Zkouška byla náročná, ale díky kvalitním skriptům od Martina Mareše a zveřejněným otázkám je celkem přímočaré se na ni naučit. 
